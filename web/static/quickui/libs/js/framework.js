...
function changeFont(a) {
	if ($("body").css({
		...
		fontSize: a + "px"
	}), $("iframe").length > 0) for (var b = 0; b < $("iframe").length; b++) document.getElementsByTagName("iframe")[b].contentWindow.changeFont(a);
	fontSize = a
}
function changeFontFamily(a) {
	if ($("body").css({
		fontFamily: a
	}), $("iframe").length > 0) for (var b = 0; b < $("iframe").length; b++) document.getElementsByTagName("iframe")[b].contentWindow.changeFontFamily(a);
	fontFamily = a
}
...
$(function() {
	...
	a.fn.render = function() {
		...
		if (a(this).is("input")) if ("text" == a(this).attr("type")) if (a(this).hasClass("color")) {
		...
		else if (a(this).is("div")) if (a(this).hasClass("buttonGroup")) c = a(this).find(".centerButton").length, d = null != a(this).attr("itemWidth") ? Number(a(this).attr("itemWidth")) : groupButtonWidth, "IE7" == broswerFlag ? a(this).css("width", 2 * d + d * c + (c + 1) + "px") : a(this).css("width", 2 * d + d * c + 2 + "px"), a(this).find(".centerButton").css("width", d + "px"), a(this).find(".popupMenu").css("width", d + "px"), a(this).find(".leftButton,.rightButton").css("width", d + "px"), ("true" == a(this).attr("radio") || 1 == a(this).attr("radio")) && a(this).find(">span").click(function() {
		...
		else if (a(this).hasClass("pageNumber")) if (0 == a(this).attr("autoRender") || "false" == a(this).attr("autoRender"));
		else try {
		...
		splitMode ? null != a(this).attr("fileBtnWidth") && (c = Number(a(this).attr("fileBtnWidth"))) : (e = a(window.top.document.getElementById("theme")), null != e.attr("defaultFileInputWidth") && (d = Number(e.attr("defaultFileInputWidth"))), null != e.attr("fileBtnWidth") && (c = Number(e.attr("fileBtnWidth")))), a(this).attr("fileWidth") ? b = Number(a(this).attr("fileWidth")) : 0 != d && (b = d), a(this).addClass("fileComponent"), a(this).wrap('<div class="file-container"></div>'), f = a('<table cellspacing="0" cellpadding="0" style="border-style:none;position:absolute;z-index:10;"><tr><td class="ali01" style="border-style:none;padding:0;margin:0;"><input type="text" class="textinput"/></td><td class="ali01" style="border-style:none;;padding:0;margin:0;"><input type="button" keepDefaultStyle="true" class="fileBtn" value="" /></td></tr></table>'), g = a(this).parent(), g.wrap('<div class="file-container-main"></div>'), h = g.parent(), g.prepend(f), i = f.find("input[type=text]"), i.css({
			...
			} else "firefox" == broswerFlag ? b = a(this).val() : (d = a(this).val().toString().split("\\"), b = d[d.length - 1]);
			if (e = a(this).parent().find("input[type=text]"), e.val(b), "false" != a(this).attr("showInfo")) {
				a(this).attr("title", b);
				try {} catch (c) {}
...
function(a) {
	...
	return b = jQuery.extend({
		...
		function f() {
			...
			if (i[1] < j && b.num_edge_entries > 0) for (j - b.num_edge_entries > i[1] && b.ellipse_text && jQuery("<span class='ellipse'>" + b.ellipse_text + "</span>").appendTo(h), o = Math.max(j - b.num_edge_entries, i[1]), n = o; j > n; n++) l(n);
