...
<div class="page_content">
	<div class="infoCard" style="width: 650px;">
	    <div class="title">
	        <span>图形化方案</span>
	    </div>
	    <div class="content" style="padding-left:15px;">
	    	<ul class="sgList">
				<li class="listPoint">QUICK UI图形化方案是基于raphael.js开发的</li>
				<li class="listPoint">raphael.js是一个跨浏览器的图形库，针对低版本IE浏览器采用vml方案，高版本浏览器采用svg方案</li>
				<li class="listPoint">这部分所有案例均可兼容到IE7</li>
			</ul>
	    </div>
	</div>	
